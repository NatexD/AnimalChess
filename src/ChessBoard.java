...
public class ChessBoard{
    ...
    //
    ImageIcon river = new ImageIcon (getClass().getResource("animal/chess/Assets/river.png"));
    ImageIcon grass = new ImageIcon (getClass().getResource("animal/chess/Assets/grass.png"));
    ImageIcon den = new ImageIcon (getClass().getResource("animal/chess/Assets/den.png"));
    ImageIcon trap = new ImageIcon (getClass().getResource("animal/chess/Assets/trap.png"));
